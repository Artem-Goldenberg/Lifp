#include <stdio.h>
//
//#define ValueTypes Int, Bool, Real, Null, Node
//
//// Defines enum with mangled names for Int, Bool, etc...
//// Also defines static struct valueType, which can be used
//// to access every item in ValueTypes as `valueType.Bool` for example
//UtilDefinitionsFor(ValueType, valueType)
